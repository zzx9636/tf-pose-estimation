...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/zixu/Extra_Disk/Dataset/PoseTrack/posetrack_data/annotations')
    parser.add_argument('--imgpath', type=str, default='/home/zixu/Extra_Disk/Dataset/PoseTrack/images')
